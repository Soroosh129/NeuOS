...
tools/CMakeFiles/caffe.bin.dir/caffe.cpp.o: ../tools/caffe.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/nvidia/caffe-build-dvfs/build-gpu/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tools/CMakeFiles/caffe.bin.dir/caffe.cpp.o"
	cd /home/nvidia/caffe-build-dvfs/build-gpu/tools && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/caffe.bin.dir/caffe.cpp.o -c /home/nvidia/caffe-build-dvfs/tools/caffe.cpp
...
tools/CMakeFiles/caffe.bin.dir/caffe.cpp.i: cmake_force
	...
	cd /home/nvidia/caffe-build-dvfs/build-gpu/tools && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/nvidia/caffe-build-dvfs/tools/caffe.cpp > CMakeFiles/caffe.bin.dir/caffe.cpp.i
...
tools/CMakeFiles/caffe.bin.dir/caffe.cpp.s: cmake_force
	...
	cd /home/nvidia/caffe-build-dvfs/build-gpu/tools && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/nvidia/caffe-build-dvfs/tools/caffe.cpp -o CMakeFiles/caffe.bin.dir/caffe.cpp.s
...
tools/caffe: tools/CMakeFiles/caffe.bin.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/nvidia/caffe-build-dvfs/build-gpu/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable caffe"
	cd /home/nvidia/caffe-build-dvfs/build-gpu/tools && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/caffe.bin.dir/link.txt --verbose=$(VERBOSE)
...
tools/CMakeFiles/caffe.bin.dir/clean:
	cd /home/nvidia/caffe-build-dvfs/build-gpu/tools && $(CMAKE_COMMAND) -P CMakeFiles/caffe.bin.dir/cmake_clean.cmake
.PHONY : tools/CMakeFiles/caffe.bin.dir/clean

tools/CMakeFiles/caffe.bin.dir/depend:
	cd /home/nvidia/caffe-build-dvfs/build-gpu && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/nvidia/caffe-build-dvfs /home/nvidia/caffe-build-dvfs/tools /home/nvidia/caffe-build-dvfs/build-gpu /home/nvidia/caffe-build-dvfs/build-gpu/tools /home/nvidia/caffe-build-dvfs/build-gpu/tools/CMakeFiles/caffe.bin.dir/DependInfo.cmake --color=$(COLOR)
