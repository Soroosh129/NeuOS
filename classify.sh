...
LD_PRELOAD=/usr/local/lib/libenergymon-odroid.so /home/nvidia/caffe-build-dvfs/build-cudnn/examples/cpp_classification/classification.bin \
  $proto \
  $weight \
  ...
  5\
  /home/nvidia/caffe-build-dvfs/vggnet-med.config\
