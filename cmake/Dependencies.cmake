...
pkg_check_modules(ENERGYMON REQUIRED energymon-odroid)
list(APPEND Caffe_INCLUDE_DIRS PUBLIC  ${ENERGYMON_INCLUDE_DIRS})
list(APPEND Caffe_LINKER_LIBS PUBLIC -L${ENERGYMON_LIBDIR} ${ENERGYMON_LIBRARIES})
