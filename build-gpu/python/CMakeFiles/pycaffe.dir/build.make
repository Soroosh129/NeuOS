...
python/CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.o: ../python/caffe/_caffe.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/nvidia/caffe-build-dvfs/build-gpu/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object python/CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.o"
	cd /home/nvidia/caffe-build-dvfs/build-gpu/python && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.o -c /home/nvidia/caffe-build-dvfs/python/caffe/_caffe.cpp
...
python/CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.i: cmake_force
	...
	cd /home/nvidia/caffe-build-dvfs/build-gpu/python && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/nvidia/caffe-build-dvfs/python/caffe/_caffe.cpp > CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.i
...
python/CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.s: cmake_force
	...
	cd /home/nvidia/caffe-build-dvfs/build-gpu/python && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/nvidia/caffe-build-dvfs/python/caffe/_caffe.cpp -o CMakeFiles/pycaffe.dir/caffe/_caffe.cpp.s
...
lib/_caffe.so: python/CMakeFiles/pycaffe.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/nvidia/caffe-build-dvfs/build-gpu/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX shared library ../lib/_caffe.so"
	cd /home/nvidia/caffe-build-dvfs/build-gpu/python && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/pycaffe.dir/link.txt --verbose=$(VERBOSE)
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold "Creating symlink /home/nvidia/caffe-build-dvfs/python/caffe/_caffe.so -> /home/nvidia/caffe-build-dvfs/build-gpu/lib/_caffe.so"
	cd /home/nvidia/caffe-build-dvfs/build-gpu/python && ln -sf /home/nvidia/caffe-build-dvfs/build-gpu/lib/_caffe.so /home/nvidia/caffe-build-dvfs/python/caffe/_caffe.so
	cd /home/nvidia/caffe-build-dvfs/build-gpu/python && /usr/bin/cmake -E make_directory /home/nvidia/caffe-build-dvfs/python/caffe/proto
	cd /home/nvidia/caffe-build-dvfs/build-gpu/python && touch /home/nvidia/caffe-build-dvfs/python/caffe/proto/__init__.py
	cd /home/nvidia/caffe-build-dvfs/build-gpu/python && cp /home/nvidia/caffe-build-dvfs/build-gpu/include/caffe/proto/*.py /home/nvidia/caffe-build-dvfs/python/caffe/proto/
...
python/CMakeFiles/pycaffe.dir/clean:
	cd /home/nvidia/caffe-build-dvfs/build-gpu/python && $(CMAKE_COMMAND) -P CMakeFiles/pycaffe.dir/cmake_clean.cmake
.PHONY : python/CMakeFiles/pycaffe.dir/clean

python/CMakeFiles/pycaffe.dir/depend:
	cd /home/nvidia/caffe-build-dvfs/build-gpu && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/nvidia/caffe-build-dvfs /home/nvidia/caffe-build-dvfs/python /home/nvidia/caffe-build-dvfs/build-gpu /home/nvidia/caffe-build-dvfs/build-gpu/python /home/nvidia/caffe-build-dvfs/build-gpu/python/CMakeFiles/pycaffe.dir/DependInfo.cmake --color=$(COLOR)
